...
| source      | string                                                         | **Optional** | v6.0.0    | n.a |  UI                                                                                                                                                                   | the entity that contains GPS position |
...
|-------------------|----------------------------------------------------------------|-----------|-------------------------|
| show_on_map             | boolean                                                         | v3.1.0    | bolean that allow to display on map the monitored tide location                                            |
