...
class WordTide_Data_Coordinator:
    ...
    def _retrieve_tide_station(self):
        ...
        if self._worldtidesinfo_server.retrieve_tide_station():
            ...
            init_data_request_time = self._worldtidesinfo_server.retrieve_tide_station_request_time()
            self._worldtidesinfo_server_scheduler.store_init_data(init_data,init_data_request_time)
