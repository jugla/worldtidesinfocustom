...
class WorldTidesInfoCustomSensor(RestoreEntity, WorldTidesInfoCustomSensorGeneric):
    ...
    def device_state_attributes(self):
        ...
        attr["current_lat"] = self._live_position_management.get_current_lat_or_ref_if_static()
        attr["current_long"] = self._live_position_management.get_current_long_or_ref_if_static()
